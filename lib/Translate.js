...
/***/ (function(module, exports, __webpack_require__) {
	...
	var IconTranslate = function (_React$Component) {
	  _inherits(IconTranslate, _React$Component);

	  function IconTranslate() {
	    _classCallCheck(this, IconTranslate);

	    return _possibleConstructorReturn(this, (IconTranslate.__proto__ || Object.getPrototypeOf(IconTranslate)).apply(this, arguments));
	  }

	  _createClass(IconTranslate, [{
	    key: 'render',
	    value: function render() {
	      try {
	        ...
	        console.error('cant\'t find svg: translate');
	        return null;
	      }
	    }
	  }]);
