...
/***/ (function(module, exports, __webpack_require__) {
	...
	var IconDoubt = function (_React$Component) {
	  _inherits(IconDoubt, _React$Component);

	  function IconDoubt() {
	    _classCallCheck(this, IconDoubt);

	    return _possibleConstructorReturn(this, (IconDoubt.__proto__ || Object.getPrototypeOf(IconDoubt)).apply(this, arguments));
	  }

	  _createClass(IconDoubt, [{
	    key: 'render',
