...
/***/ (function(module, exports, __webpack_require__) {
	...
	var IconFileXml = function (_React$Component) {
	  _inherits(IconFileXml, _React$Component);

	  function IconFileXml() {
	    _classCallCheck(this, IconFileXml);

	    return _possibleConstructorReturn(this, (IconFileXml.__proto__ || Object.getPrototypeOf(IconFileXml)).apply(this, arguments));
	  }

	  _createClass(IconFileXml, [{
	    key: 'render',
