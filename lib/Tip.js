...
/***/ (function(module, exports, __webpack_require__) {
	...
	var IconTip = function (_React$Component) {
	  _inherits(IconTip, _React$Component);

	  function IconTip() {
	    _classCallCheck(this, IconTip);

	    return _possibleConstructorReturn(this, (IconTip.__proto__ || Object.getPrototypeOf(IconTip)).apply(this, arguments));
	  }

	  _createClass(IconTip, [{
	    key: 'render',
